...
CHAPTERS = [
    ("01.foundation-and-master-data.md", "Foundation and master data", "Set up corporations, accounts, masters, and vendors.", "i-lucide-database"),
    ("02.projects.md", "Projects", "Create and manage construction projects.", "i-lucide-building-2"),
    ("03.cost-codes.md", "Cost codes", "Configure cost code divisions and configurations.", "i-lucide-hash"),
    ("04.item-types-and-items.md", "Item Types and Items List", "Maintain item types and the preferred-item catalog.", "i-lucide-boxes"),
    ("05.estimates.md", "Estimates", "Create the project budget and approval workflow.", "i-lucide-calculator"),
    ("06.purchase-orders.md", "Purchase Orders", "Commit material or labor from a vendor.", "i-lucide-shopping-cart"),
    ("07.change-orders.md", "Change Orders", "Modify an existing purchase order commitment.", "i-lucide-git-branch"),
    ("08.stock-receipt-notes.md", "Stock Receipt Notes (GRN)", "Record material shipment and receipt.", "i-lucide-package-check"),
    ("09.vendor-invoices.md", "Vendor Invoices", "Record vendor invoices, advances, and holdback.", "i-lucide-receipt"),
...
def main() -> None:
    ...
    for order, (part, (filename, title, description, icon)) in enumerate(zip(parts, CHAPTERS), start=1):
        body = part.strip()
